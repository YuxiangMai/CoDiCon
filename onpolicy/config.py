...
def get_config():
    ...
    parser.add_argument("--algorithm_name", type=str,
                        default='mappo', choices=["rmappo", "mappo", "happo", "hatrpo", "mat", "mat_dec", "cc"])
    ...
    parser.add_argument("--user_name", type=str, default='myx', help="[for wandb usage], to specify user's name for simply collecting training data.")
    ...
    parser.add_argument("--intrinsic_lr", type=float, default=5e-4,
                        help='intrinsic module learning rate (default: 5e-4)')
    ...
    parser.add_argument("--value_mix_loss_coef", type=float,
                        default=1, help='value_mix loss coefficient (default: 0.5)')
    parser.add_argument("--intrinsic_reward_var_coef", type=float,
                        default=0.1, help='intrinsic reward var loss coefficient (default: 0.1)')
    ...
    parser.add_argument("--eval_interval", type=int, default=12, help="time duration between contiunous twice evaluation progress.")
