...
from onpolicy.envs.pacmen_cross.Pacmen_Env import PacmenCross

"""Train script for PACMEN."""

def make_train_env(all_args):
    def get_env_fn(rank):
        def init_env():
            if all_args.env_name == "pacmen":
                env = PacmenCross(all_args, )
            else:
...
def parse_args(args, parser):
    parser.add_argument('--map_name', type=str, default='tini',
...
def main(args):
    ...
    elif all_args.algorithm_name == "cc":
        print("u are choosing to use cc, we set use_naive_recurrent_policy to be True")
    ...
    if all_args.share_policy:
        if all_args.algorithm_name == "cc":
            from onpolicy.runner.shared.pacmen_runner import PACMENRunner as Runner
        else:
            from onpolicy.runner.shared.pacmen_runner import PACMENRunner as Runner
    else:
